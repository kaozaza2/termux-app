...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'HOME','UP','END','PGUP','PASTE'], ['TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN',{key:'KEYBOARD',popup:{macro:'CTRL c'}}]]"; // Double row
